...
function getFoodCategories(foods) {
  const result = foods.map(function(suitable){
    if (suitable.isVegetarian){
      return suitable.food + " " + "is suitable for vegetarians"
    }return suitable.food + " " + "is not suitable for vegetarians";
  });
  return(result);
}
